...
import { ArrowLeft, Save, Upload, Plus, ArrowUp, ArrowDown, Trash2, Image as ImageIcon, AlignLeft } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        date: formatDisplayDate(formData.date) || formData.date,
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] font-sans text-neutral-900 p-6 lg:p-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-serif font-medium text-neutral-900 mb-2">Create New Post</h1>
          <p className="text-neutral-500">Add a new article to your blog.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-900 focus:bg-white focus:border-neutral-900 outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
            ...
            <div>
              ...
              <input
                ...
                className="hidden"
                id="blog-mobile-cover-upload-new"
                disabled={uploadingMobileCover}
              />
              <label
                htmlFor="blog-mobile-cover-upload-new"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Write your full article here. You can use plain text or simple HTML (e.g. <p>, <h2>, <strong>)."
              />
